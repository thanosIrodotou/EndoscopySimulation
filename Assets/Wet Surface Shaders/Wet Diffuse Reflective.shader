...
_ReflectionIntensity("_ReflectionIntensity", Range(0,1) ) = 0.5
...
float4 Multiply0=Tex2D2 * _ReflectionIntensity.xxxx;
...
float4 TexCUBE0=texCUBE(_Reflection,WorldReflection0);
float4 Multiply4=Multiply0 * TexCUBE0;
float4 Add0=Subtract0 + Multiply4;
float4 Multiply1=Add0 * _DiffuseColor;
